...
def test_metadata_modificada_rechazada():
    ...
    tampered["metadata"]["filename"] = "otro_archivo.txt"

    with pytest.raises(InvalidSignature):
        crypto.verify_and_decrypt(tampered, signing_pub, "alice", alice_priv, "decrypted_test.txt")
